#!/bin/bash
echo ================ request 1 ================
wget -S -O resp01.html --load-cookies=/dev/null   --save-cookies=cooks01.txt --keep-session-cookies --no-check-certificate https://roomscheduling.uwm.edu/25live/data/run/login.shibboleth?redirect=https://roomscheduling.uwm.edu/25live/index.html


echo ================ request 2 ================
wget -S -O resp02.html --load-cookies=cooks01.txt --save-cookies=cooks02.txt --keep-session-cookies --no-check-certificate --post-data 'j_username=tomh&j_password=%23%23rq52FADA&s=Log+in' --max-redirect=0 https://idp.uwm.edu/idp/Authn/UserPassword

echo ============== request 2.5 ===============
wget -S -O resp025.html --load-cookies=cooks02.txt --save-cookies=cooks025.txt --keep-session-cookies --no-check-certificate 'https://idp.uwm.edu/idp/profile/SAML2/Redirect/SSO'
